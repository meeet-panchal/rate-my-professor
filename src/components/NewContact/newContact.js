          ...
          <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                <span
                  class=" mb-4 block text-base font-semibold"
                ...
                <p class="text-body-color mb-9 text-base leading-relaxed">
                  ...
                  further queries and we will get back to you at the earliest to
                  resolve any queries.
                </p>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div
                    class="text-white mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                    style={{ backgroundColor: "rgb(235, 100, 64)" }}
                  >
                    <svg
                      width="24"
                      height="24"
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">(+1) 832-065-0059</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div
              ...
              <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      class="w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      style={{ backgroundColor: "hsla(184, 23%, 37%, 0.859)" }}
                    >
                      Send Message
                    </button>
                  </div>
